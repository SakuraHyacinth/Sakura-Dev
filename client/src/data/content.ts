...
export const jobs: Jobs[] = [
  ...
  { title: 'STEM SC Tutor', employer: 'CSUSM', time: 'January 2024 - December 2024', description: 'Assisted students in exam prep, homework help, lecture review, and explained concepts. Supported courses including Computer Science I & II, Data Structures, Calculus I & II, Assembly and Digital Circuits, Algebra, and Discrete Mathematics, helping students develop professional problem-solving and programming skills.' },
  { title: 'Summer Engineering Instructor', employer: 'IEEE TryEngineering @ USD', time: 'June 2024 - July 2024', description: 'Taught an engineering curriculum for students grades 9th-12th. Taught engineering concepts including civil engineering, mechanical engineering, electrical engineering, and aerospace engineering.' },
  { title: 'Calculus I Learning Assistant', employer: 'CSUSM', time: 'August 2023 - December 2023', description: 'Tutored Calculus 1, set up office hours, taught one-on-one tutoring sessions with students, and tutored groups of students.' },
