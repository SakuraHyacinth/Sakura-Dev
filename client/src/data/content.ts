...
export const games: Games[] = [
  ...
  { title: 'Abiotic Factor', description: 'I get lost and extremely disoriented easily, which made me quit this game at first, but I figured it out somehow. I also just like making soup out of alien stuff. 10/10 would play with friends again to domesticate aliens and give them armor.', image: Abiotic, tags: ['Survival', 'Co-op', 'Sci-Fi'] },
